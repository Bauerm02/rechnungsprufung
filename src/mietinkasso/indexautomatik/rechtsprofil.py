        ...
        if profil.vertragsklausel_id is not None:
            ...
            if klausel is not None:
                klausel_snapshot = {
                    ...
                    "letzte_anpassung_monat": klausel.letzte_anpassung_monat,
                    "berechnungsprofil": klausel.berechnungsprofil,
                    "abschlussdatum": klausel.abschlussdatum.isoformat(),
                    "klausel_text": klausel.klausel_text,
                    ...
                    "terminmodus": klausel.terminmodus,
                    "schwellenkorridor_rundung_dezimalstellen": klausel.schwellenkorridor_rundung_dezimalstellen,
